...
class Generator(nn.Module):
    ...
    def __init__(self, z_dim):
        ...
        t1 = Tree(planes * 8, in_planes=planes * 2, out_planes=planes * 2, dense_depth=planes // 4, level=2,
                  block_num=1,
                  feature_size=8)
        ...
        t2 = Tree(planes * 4, in_planes=planes, out_planes=planes, dense_depth=planes // 8, level=2,
                  block_num=1,
                  feature_size=16)
        ...
        t3 = Tree(planes * 2, in_planes=planes // 2, out_planes=planes // 2, dense_depth=planes // 16, level=2,
                  block_num=1,
                  feature_size=32)
        ...
        t4 = Tree(planes, in_planes=planes // 4, out_planes=planes // 4, dense_depth=planes // 32, level=2,
                  block_num=1,
                  feature_size=64)
