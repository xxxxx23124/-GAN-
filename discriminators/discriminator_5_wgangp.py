...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.rir2 = RiRBlock(base, base, 2, 1)  # 64
        self.rir3 = RiRBlock(base, base * 2, 2, 2)  # 32
        self.rir4 = RiRBlock(base * 2, base * 2, 2, 2)  # 16
        self.rir5 = RiRBlock(base * 2, base * 2, 2, 1)
        self.rir6 = RiRBlock(base * 2, base * 4, 2, 2)  # 8
        self.rir7 = RiRBlock(base * 4, base * 4, 2, 2)  # 4
